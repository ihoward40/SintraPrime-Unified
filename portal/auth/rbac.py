...
ROLE_PERMISSIONS: dict[Role, frozenset[Permission]] = {
    ...
    Role.FIRM_ADMIN: frozenset(
        [
            ...
            Permission.CASE_CONFLICT_CHECK,
            Permission.MATTER_INTELLIGENCE_READ,
            Permission.MATTER_INTELLIGENCE_WRITE,
            Permission.MATTER_INTELLIGENCE_REVIEW,
            Permission.MATTER_INTELLIGENCE_EXPORT,
            # Documents
            ...
            Permission.MSG_SEND,
            Permission.MSG_READ,
            Permission.MSG_DELETE,
            Permission.MSG_CREATE_THREAD,
            # Billing
            Permission.BILLING_READ,
            Permission.BILLING_CREATE,
            Permission.BILLING_UPDATE,
            Permission.BILLING_DELETE,
            Permission.BILLING_TIME_TRACK,
            Permission.BILLING_TRUST,
            Permission.BILLING_REPORT,
            Permission.PAYMENT_PROCESS,
            # Notifications
            Permission.NOTIF_READ,
            Permission.NOTIF_MANAGE,
            # Admin
...
class CurrentUser:
    ...
    def __init__(self, payload: dict):
        ...
        if not isinstance(raw_permissions, Iterable) or isinstance(
            raw_permissions, (str, bytes, Mapping)
        ):
        ...
        self.permissions: frozenset[Permission] = frozenset(
            Permission(p) for p in raw_permissions_list
        )
