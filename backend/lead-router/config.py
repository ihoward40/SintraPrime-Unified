...
class Config:
    ...
    AIRTABLE_API_KEY = os.getenv("AIRTABLE_API_KEY", "pat_dummy_key_for_testing")
    AIRTABLE_BASE_ID = os.getenv("AIRTABLE_BASE_ID", "appDummy123ForTesting")
    ...
    CALENDLY_URL = os.getenv("CALENDLY_URL", "https://calendly.com/sintraprime/demo")
...
def load_config() -> Config:
    ...
    if not config.SENDGRID_API_KEY or "dummy" in config.SENDGRID_API_KEY:
        ...
        warnings.warn("SENDGRID_API_KEY not configured. Email service will use stubs.", UserWarning)
