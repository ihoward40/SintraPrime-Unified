...
def test_connection_lifecycle():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Explicit close
        store1.close()
        print("[OK] store.close() completed")
        ...
        print("[OK] Checkpoint loaded after reopen")
        ...
        with DurableStore(str(db_path)) as store3:
            ...
            print("[OK] Checkpoint saved in context manager")
        # Context manager should auto-close
        print("[OK] Context manager auto-closed")
        ...
        print("[OK] Data persisted after context manager close")
        store4.close()
        ...
        print("[OK] 5 sequential connections succeeded (no file locks)")
        ...
        final_store.close()
        print("[OK] Database accessible after WAL operations")
        
    print("\n[6] All connection lifecycle tests passed")
    print("[OK] Explicit close() works")
    print("[OK] Reopen after close works")
    print("[OK] Context manager cleanup works")
    print("[OK] No file lock conflicts")
    print("[OK] WAL mode managed properly")
