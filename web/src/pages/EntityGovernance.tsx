...
const entities = [
  {
    id: 'e1', name: 'Sample Law & Financial Group LLC', type: 'llc', status: 'active', state: 'New York',
    formation: '2018-03-15', ein: '82-1234567',
    registeredAgent: 'CT Corporation System, 28 Liberty St, New York, NY 10005',
    officers: [{ name: 'Demo Principal', title: 'Managing Member', ownership: 100 }],
    children: ['e2', 'e3', 'e5'],
    compliance: { nextDue: '2025-03-31', status: 'current' },
  },
  {
    id: 'e2', name: 'Sample Holdings LLC', type: 'llc', status: 'active', state: 'Delaware',
    formation: '2019-07-22', ein: '84-7654321',
    registeredAgent: 'Registered Agent Solutions, 9 E Loockerman St, Dover, DE 19901',
    officers: [{ name: 'Demo Principal', title: 'Member', ownership: 100 }],
    children: ['e4'],
    parent: 'e1',
    compliance: { nextDue: '2025-06-01', status: 'current' },
  },
  {
    id: 'e3', name: 'Sample Consulting LLC', type: 'llc', status: 'active', state: 'Nevada',
  ...
  },
  {
    ...
    officers: [{ name: 'Demo Principal', title: 'Member', ownership: 75 }, { name: 'James Porter', title: 'Member', ownership: 25 }],
    children: [],
    parent: 'e2',
    compliance: { nextDue: '2024-06-01', status: 'overdue' },
  },
  {
    id: 'e5', name: 'Sample Family Irrevocable Trust', type: 'trust', status: 'active', state: 'Nevada',
    formation: '2020-09-18', ein: '87-5544332',
    registeredAgent: 'Nevada Trust Company',
    officers: [{ name: 'Demo Principal', title: 'Trustee', ownership: 0 }, { name: 'Sample Family Members', title: 'Beneficiaries', ownership: 100 }],
    children: [],
    parent: 'e1',
    compliance: { nextDue: '2025-01-01', status: 'current' },
  },
  {
    id: 'e6', name: 'Sample Real Estate Corp', type: 'corporation', status: 'active', state: 'New York',
    formation: '2022-02-28', ein: '88-6677889',
    registeredAgent: 'CT Corporation System',
    officers: [{ name: 'Demo Principal', title: 'President & CEO', ownership: 100 }],
    children: [],
    compliance: { nextDue: '2025-02-28', status: 'current' },
  },
  {
    id: 'e7', name: 'Sample Charitable Foundation', type: 'nonprofit', status: 'active', state: 'New York',
    formation: '2023-05-15', ein: '89-1234568',
    registeredAgent: 'Foundation Legal Services LLC',
    officers: [{ name: 'Demo Principal', title: 'Executive Director', ownership: 0 }],
    children: [],
