...
class MemoryService:
    ...
    async def ingest(
        ...
        self._generate_links(memory_id, atoms)
    ...
    def _classify(
        self, source_class: MemorySourceClass, data: str, metadata: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _index_memory(
        self, memory_id: str, atoms: List[Dict[str, Any]], metadata: Dict[str, Any]
    ):
    ...
    def _assign_trust_level(
        self, source_class: MemorySourceClass, metadata: Dict[str, Any]
    ) -> TrustLevel:
    ...
    async def _record_receipt(
        self, memory_id: str, content_hash: str, trust_level: TrustLevel, principal_id: str
    ):
