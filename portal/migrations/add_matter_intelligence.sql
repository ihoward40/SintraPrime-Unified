...
CREATE TABLE IF NOT EXISTS matter_accounts (
    ...
    creditor_party_id VARCHAR(36) REFERENCES matter_parties(id),
    collector_party_id VARCHAR(36) REFERENCES matter_parties(id),
    furnisher_party_id VARCHAR(36) REFERENCES matter_parties(id),
    servicer_party_id VARCHAR(36) REFERENCES matter_parties(id),
    assignee_party_id VARCHAR(36) REFERENCES matter_parties(id),
...
CREATE TABLE IF NOT EXISTS matter_filings (
    ...
    secured_party_id VARCHAR(36) REFERENCES matter_parties(id),
...
CREATE TABLE IF NOT EXISTS matter_communications (
    ...
    sender_party_id VARCHAR(36) REFERENCES matter_parties(id),
    recipient_party_id VARCHAR(36) REFERENCES matter_parties(id),
...
CREATE TABLE IF NOT EXISTS matter_disputes (
    ...
    tenant_id VARCHAR(36) NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    matter_id VARCHAR(36) NOT NULL REFERENCES matters(id) ON DELETE CASCADE,
    account_id VARCHAR(36) REFERENCES matter_accounts(id),
...
CREATE TABLE IF NOT EXISTS matter_assessment_versions (
    ...
    tenant_id VARCHAR(36) NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    matter_id VARCHAR(36) NOT NULL REFERENCES matters(id) ON DELETE CASCADE,
    assessment_id VARCHAR(36) NOT NULL REFERENCES matter_assessments(id) ON DELETE CASCADE,
