...
- Agent permissions are described in [`orchestration/agent_registry.json`](../../orchestration/agent_registry.json).
...
| Agent registry | ACTIVE | `orchestration/agent_registry.json` |
