...
### Monetization (Case Start) Endpoint
Make.com should call this **after** Stripe reports payment success.

```
POST /api/monetization/start-case
```
...
```json
{
  ...
  "phone": "555-0100",
  "case_id": "C-2026-06-20-0001",
  "case_type": "credit_dispute",
  "matter_type": "FCRA",
  "creditor_name": "Experian"
}
```

Behavior:
- creates `clients/<case_id>/` scaffold
- runs the draft generator for that case (draft-only)
- returns draft generation + initialization ledger receipt info
