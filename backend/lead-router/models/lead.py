...
class IntakeData(BaseModel):
    ...
    financial_snapshot: str = Field(
        ..., min_length=10, description="Description of financial situation"
    )
    ...
    timeline: Optional[str] = Field(
        default=None, description="Urgency/timeline: immediate, within-6-months, long-term, etc."
    )
    ...
    referral_source: Optional[str] = Field(
        default="organic", description="How they heard about us: organic, referral, ad, event, etc."
    )
...
class Lead(BaseModel):
    ...
    urgency_score: float
    qualification_score: float = Field(..., ge=0, le=100, description="Overall lead quality score")
