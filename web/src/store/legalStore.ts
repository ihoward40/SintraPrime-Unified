...
const mockCases: Case[] = [
  {
    ...
    title: 'Sample v. Metropolitan Housing Authority',
    ...
    parties: [
      { id: 'p1', name: 'Sample Plaintiff', role: 'plaintiff' },
    ...
    motions: [],
    assignedAttorney: 'Demo Attorney',
  ...
  },
  {
    ...
    title: 'Sample Family Trust - UCC Article 9 Dispute',
    ...
    parties: [
      { id: 'p5', name: 'Sample Family Trust', role: 'petitioner' },
  ...
  },
  {
    ...
    title: 'TechCorp v. Sample Consulting - IP Dispute',
    ...
    parties: [
      ...
      { id: 'p10', name: 'Sample Consulting LLC', role: 'defendant' },
    ],
    documents: [],
    courtDates: [],
    motions: [],
