...
| REQ-7-I12 | ADR-MC-001 §7 (I12) | Policy snapshot validity is bounded to the exact pinned snapshot in the capability | C02, C07 | UT-C07-001–UT-C07-004, RT-02.09, RT-05.09, INT-015, SEC-026 | AC16 | CERT-001, CERT-005 |
...
| REQ-9.1-C07 | ADR-MC-001 §9.1, §2.11 | Policy snapshot registry — pin and validate policy snapshots by hash | UT-C07-001–UT-C07-007, RT-02.09, RT-05.09, INT-015 | I12 | AC16 | CERT-001, CERT-008 |
...
| REQ-11-AC16 | ADR-MC-001 §11 (AC16) | Policy snapshot is pinned by hash and bounded by validity time | C02, C07, C14 | UT-C07-*, RT-02.09, RT-05.09, INT-015, SEC-026 | I12 | CERT-001, CERT-006 |
...
| REQ-A2-2.5-07 | ADR-002 §2.5 (Stale Approval Invalidation) | If a policy has tightened since an approval was granted, the approval is invalidated and the intent must be re-authorized under the current policy version | C07, C02, C06 | UT-C07-003, RT-01.8, RT-05.09 | I12, I13 | AC16, AC17 | CERT-001 |
...
| REQ-A2-2.5-12 | ADR-002 §2.5 (Privilege Boundaries) | Executors operate with least-privilege credentials; the Brain does not grant executors permissions beyond what the originating actor's policy allows | C02, C07 | UT-C02-012, UT-C02-013, RT-05.08, RT-16.10 | I3, I15 | AC2, AC18 | CERT-001, CERT-016 |
...
| I12 | REQ-2.3-08, REQ-2.11-*, REQ-7-I12, REQ-A2-2.5-06–07 | UT-C07-*, RT-02.09, RT-05.09, INT-015, SEC-026 | Yes |
...
| AC16 | REQ-2.3-08, REQ-2.11-*, REQ-2.15-08, REQ-7-I12, REQ-A2-2.5-06–07 | UT-C07-*, RT-02.09, RT-05.09, INT-015, SEC-026 | CERT-001, CERT-006 | Yes |
...
| C07 | REQ-2.1.1-02, REQ-2.1.2-02, REQ-2.2.1-05, REQ-2.11-*, REQ-2.14-06, REQ-2.15-08, REQ-A2-2.5-06–07, REQ-A2-2.5-16 | UT-C07-*, RT-02.09, RT-05.09, INT-015 | CERT-001, CERT-008 | Yes |
