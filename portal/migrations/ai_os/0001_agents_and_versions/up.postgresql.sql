...
--
-- PostgreSQL override: adds the deferred current_version_id foreign key.
-- SQLite cannot ALTER TABLE ADD CONSTRAINT, so the neutral up.sql omits it.
...
ALTER TABLE ai_os_agents
    ADD CONSTRAINT fk_ai_os_agents_current_version
    FOREIGN KEY (current_version_id)
    REFERENCES ai_os_agent_versions (id)
    ON DELETE RESTRICT
