...
- Streaming (`chat_stream`) and built-in tool handlers remain on legacy paths in this phase.
...
- Run `python -m pytest agents/chat/tests/test_chat_agent_governed.py -q` after changing governed inference routing.
